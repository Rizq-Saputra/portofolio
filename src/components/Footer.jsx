  ...
  return (
    <footer className="mt-16 sm:mt-64 bg-[#1D1B24] px-4 sm:px-8 md:px-24 py-8 sm:py-20">
      <div className="mx-auto text-center">
        <p className="font-bold text-secondary_purple text-lg sm:text-xl text-nowrap">
          Created By Rizq Saputra
        </p>
        <ul className="flex justify-center text-white gap-6 sm:gap-8 mt-4 sm:mt-6">
          <li className="cursor-pointer hover:text-secondary_purple hover:transition-all hover:duration-500 hover:ease-in-out">
            <Link to="/" href="#">
              Home
            </Link>
          </li>
        ...
        <ul className="flex justify-center text-white gap-3 sm:gap-4 mt-6 sm:mt-10">
          <li className="size-10 rounded-full bg-secondary_purple cursor-pointer justify-center items-center flex hover:text-[#0e0e0e] hover:bg-white hover:transition-all hover:ease-in-out hover:duration-500">
            <a
