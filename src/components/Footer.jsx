    ...
    <footer className="mt-16 sm:mt-64 bg-[#1D1B24] px-4 sm:px-8 md:px-24 py-8 sm:py-20">
      <div className="mx-auto text-center">
        ...
        <ul className="flex justify-center text-white gap-3 sm:gap-4 mt-6 sm:mt-10">
          <li className="size-10 rounded-full bg-secondary_purple cursor-pointer justify-center items-center flex hover:text-[#0e0e0e] hover:bg-white hover:transition-all hover:ease-in-out hover:duration-500"><a className="text-lg sm:text-xl" target="_blank" aria-label="Instagram" href="https://www.instagram.com/rizqsptr/"><FaInstagram /></a></li>
          <li className="size-10 rounded-full bg-secondary_purple cursor-pointer justify-center items-center flex hover:text-[#0e0e0e] hover:bg-white hover:transition-all hover:ease-in-out hover:duration-500"><a className="text-lg sm:text-xl" target="_blank" aria-label="Facebook" href="https://www.linkedin.com/in/muhammad-rizq-saputra-378088281/"><FaLinkedin /></a></li>
          <li className="size-10 rounded-full bg-secondary_purple cursor-pointer justify-center items-center flex hover:text-[#0e0e0e] hover:bg-white hover:transition-all hover:ease-in-out hover:duration-500"><a className="text-lg sm:text-xl" target="_blank" aria-label="Github" href="https://github.com/Rizq-Saputra"><FaGithub /></a></li>
          <li className="size-10 rounded-full bg-secondary_purple cursor-pointer justify-center items-center flex hover:text-[#0e0e0e] hover:bg-white hover:transition-all hover:ease-in-out hover:duration-500"><a className="text-lg sm:text-xl" target="_blank" aria-label="Email" href="mailto:rizky002211@gmail.com"><IoMdMail /></a></li>
        </ul>
      </div>
    </footer>
  )
