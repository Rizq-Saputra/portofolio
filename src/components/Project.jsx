...
function Project() {
    return(
        <section id="project" className="mt-16 md:mt-64">
            ...
            <div className="flex flex-col md:flex-row mt-9 justify-center items-center gap-10">
                <div className="w-full md:w-1/2 hover:border-2 hover:transition-all hover:duration-500 cursor-pointer hover:ease-in-out border-secondary_purple rounded-md" data-aos="fade-up">
                    <img className="w-full rounded-md" src="/images/notes.png" alt="Project" />
                </div>
                <div className="w-full md:w-1/2 text-center md:text-left" data-aos="fade-up">
            ...
            <div className="flex justify-center mt-14"><button className="border-2 border-secondary_purple text-secondary_purple px-8 py-2 mt-4 md:mt-0 hover:bg-secondary_purple hover:text-white rounded-md transition-all duration-500 ease-in-out flex gap-2 items-center" ><FaArrowRight /><Link to='/project' >See More Project</Link></button></div>
        </section>
    );
}
